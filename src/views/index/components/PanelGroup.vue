    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('user')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="statisticalData.userNum" :duration="2800" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('article')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="statisticalData.articleNum" :duration="2800" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('login')">
        <div class="card-panel-icon-wrapper icon-login">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="statisticalData.loginNum" :duration="2800" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('music')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="statisticalData.musicNum" :duration="2800" class="card-panel-num" />
        </div>
      </div>
    </el-col>
  </el-row>
